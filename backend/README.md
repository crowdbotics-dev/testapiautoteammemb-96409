...
## Project Structure
    ...
    ├── testapiautoteammemb_96409  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_96409`
...
2. Clone this repo and `cd testapiautoteammemb_96409`
